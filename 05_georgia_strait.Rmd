...
```{r ozone-by-station, fig.asp = 1, fig.cap = ozone_by_station_cap(airzone, ozone)}
plot_ozone_by_station(ozone, airzone)
```

<!-- Annual trends in ozone concentrations -->

```{r annual-ozone, fig.width = 9, fig.height = 4, fig.cap = annual_ozone_cap(annual_ozone)}
...
```{r pm25-by-station, fig.asp = 2, fig.cap = pm25_by_station_cap(airzone, pm25)}
plot_pm25_by_station(pm25)
```

<!-- PM Annual trends in PM 2.5 -->

```{r annual-pm25, fig.width = 9, fig.height= 4, fig.cap = annual_pm25_cap(annual_pm25)}
