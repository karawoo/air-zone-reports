...
```{r airzone-map, fig.margin = TRUE, fig.cap = paste(airzone, "Air Zone")}
airzone_map(airzone)
```
...
```{r ozone-by-station, fig.asp = 1, fig.margin = TRUE, fig.cap = ozone_by_station_cap(airzone, ozone)}
...
```{r annual-ozone, fig.width = 9, fig.fullwidth = TRUE, fig.height = 4, fig.cap = annual_ozone_cap(annual_ozone)}
...
```{r pm25-by-station, fig.asp = 2, fig.margin = TRUE, fig.cap = pm25_by_station_cap(airzone, pm25)}
...
```{r annual-pm25, fig.width = 9, fig.fullwidth = TRUE, fig.height= 4, fig.cap = annual_pm25_cap(annual_pm25)}
